...
// components
import { useGetUnitById, useUpdatePartner } from '../../services/useUnitServices';

export const UnitEdit = () => {

    const navigate = useNavigate();
    const { doRequest, data: result, isLoading: isEditing } = useUpdatePartner();
    const { data, getData } = useGetUnitById();
    ...
    const formik = useFormik({
        ...
        onSubmit: async (formData) => {
            await doRequest(unitId, { name: formData.name, isActive, unitId });
        }
    });
