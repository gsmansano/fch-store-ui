...
// components
import { useCreateManufacturer } from '../../services/useManufacturerServices';

export const ManufacturerAdd = () => {

    const navigate = useNavigate();
    const { doRequest, data: result, isLoading } = useCreateManufacturer();
    ...
    useEffect(() => {
        if (result && result?.manufacturerId !== "") {
